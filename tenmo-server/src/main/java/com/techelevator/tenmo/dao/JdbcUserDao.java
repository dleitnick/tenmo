...
public class JdbcUserDao implements UserDao {
    ...
    public List<User> getUsers(String username) {
        ...
        String sql = "SELECT user_id, username, password_hash FROM tenmo_user WHERE username != ? ORDER BY username;";
        try {
    ...
    public User createUser(RegisterUserDto user) {
        ...
        try {
            ...
            if (newUser != null) {
                // create account
                sql = "INSERT INTO account (user_id, balance, is_primary, is_deleted) VALUES (?, ?, true, false)";
